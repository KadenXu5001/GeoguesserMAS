...
URBAN_SUBAGENT = {
    ...
    "system_prompt": (
        ...
        "map light pole, lamp post, streetlight, electricity pole, power pole, distribution pole, "
        "crossarm, and pole-fixture observations in built-up scenes to urban_utility_poles; "
...
RURAL_SUBAGENT = {
    ...
    "system_prompt": (
        ...
        "the lookup category that is directly useful for that object. Pass that exact observation as "
        "object_observation and repeat it in the justification. Make at most three lookups total; "
        "map light pole, lamp post, electricity pole, power pole, distribution pole, crossarm, "
        "and pole-fixture observations in rural or low-density scenes to rural_utility_poles; "
