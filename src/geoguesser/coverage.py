...
def scan_all(
    ...
    *,
    ...
    for index, candidate in enumerate(candidates, start=1):
        ...
        result = scan_country(candidate, token, max_tiles=max_tiles)
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = scan_all(args.candidates, args.output, max_tiles=args.max_tiles)
    print(
